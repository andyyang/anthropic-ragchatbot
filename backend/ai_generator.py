...
class ConversationState:
    ...
    def add_round_result(
        self, response, tool_results: List[str], tool_use_ids: List[str]
    ):
    ...
    def get_final_response(self) -> str:
        ...
        return (
            self.final_response
            or "I apologize, but I encountered an error processing your request."
        )
...
"""
    ...
    def generate_response_sequential(
        self,
        query: str,
        conversation_history: Optional[str] = None,
        tools: Optional[List] = None,
        ...
        try:
            ...
            if (
                ...
                and conversation.round_number >= max_rounds
                and not conversation.final_response
            ):
    ...
    def _execute_round(
        self, conversation: ConversationState, round_num: int, max_rounds: int
    ):
        """
        ...
        try:
            ...
            if response.stop_reason == "tool_use" and conversation.tool_manager:
                tool_results, tool_use_ids = self._execute_tools_for_round(
                    response, conversation.tool_manager
                )
                ...
                if response.content:
                    ...
                    conversation.set_final_response(
