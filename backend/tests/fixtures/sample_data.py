...
ANTHROPIC_RESPONSES = {
    "direct_response": {
        "content": [
            {"type": "text", "text": "This is a direct response without tool use."}
        ],
        ...
        "content": [
            {
                ...
                "input": {"query": "MCP basics", "course_name": "Introduction to MCP"},
            }
        ],
    ...
    "final_tool_response": {
        "content": [
            {
                "type": "text",
                "text": "Based on the search results, MCP (Model Context Protocol) is a revolutionary approach to AI integration that enables seamless communication between AI models and external tools.",
            }
        ],
        "stop_reason": "end_turn",
    },
        ...
        "content": [
            {
                ...
                "input": {"course_title": "Introduction to MCP"},
            }
        ],
        "stop_reason": "tool_use",
    },
...
EXPECTED_SEARCH_RESULTS = {
    ...
    "empty_results": {"documents": [], "metadata": [], "distances": []},
}
