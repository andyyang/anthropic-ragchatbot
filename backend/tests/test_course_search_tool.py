...
from .fixtures.sample_data import EXPECTED_SEARCH_RESULTS, ERROR_SCENARIOS
...
class TestCourseSearchToolExecute:
    ...
    def test_execute_empty_results_with_filters(self, mock_vector_store, mock_search_results):
